...
from app.models import ChartMeasurement, IndexMeasurement, StandardFactorMeasurement, StandardFactors
...
def test_map_current_measurement():
    mapper = ObjectMapper()
    assert mapper.map_current_measurement(API_RESPONSE) == {'from_date': '2021-10-18T09:06:35.404Z',
...
def test_map_chart_measurement():
    mapper = ObjectMapper()
    assert mapper.map_chart_measurement(API_RESPONSE, "history") == ChartMeasurement(labels=['2021-10-17 10:00', '2021-10-17 11:00', '2021-10-17 12:00', '2021-10-17 13:00', '2021-10-17 14:00', '2021-10-17 15:00', '2021-10-17 16:00', '2021-10-17 17:00', '2021-10-17 18:00', '2021-10-17 19:00', '2021-10-17 20:00', '2021-10-17 21:00', '2021-10-17 22:00', '2021-10-17 23:00', '2021-10-18 00:00', '2021-10-18 01:00', '2021-10-18 02:00', '2021-10-18 03:00', '2021-10-18 04:00', '2021-10-18 05:00', '2021-10-18 06:00', '2021-10-18 07:00', '2021-10-18 08:00', '2021-10-18 09:00'], datasets=[IndexMeasurement(label='PM1', backgroundColor='#51B8A9A8', data=[
        3.8, 5.81, 5.36, 6.45, 7.97, 8.38, 9.71, 10.83, 13.99, 16.02, 16.51, 17.9, 18.15, 18.7, 20.4, 22.31, 25.17, 25.88, 25.44, 22.95, 21.08, 19.82, 18.55, 16.94]), IndexMeasurement(label='PM25', backgroundColor='#e28743A8', data=[6.03, 8.23, 7.76, 8.9, 11.44, 12.08, 14.14, 15.62, 20.42, 23.21, 24.45, 26.32, 26.83, 27.76, 30.11, 32.92, 36.76, 37.8, 36.95, 33.85, 31.22, 29.23, 27.59, 24.98]), IndexMeasurement(label='PM10', backgroundColor='#25b836A8', data=[8.82, 11.96, 11.37, 12.93, 16.6, 18.04, 20.83, 23.04, 31.26, 36.92, 39.25, 42.53, 43.52, 45.06, 49.66, 54.54, 60.01, 60.86, 60.08, 56.11, 51.51, 47.75, 44.77, 40.51])])


def test_map_standard_factor():
    mapper = ObjectMapper()
    assert mapper.map_standard_factor(API_RESPONSE) == StandardFactors(factors=[StandardFactorMeasurement(
        organization_name='WHO', pollutant='PM25', limit=25.0, percent=98.17), StandardFactorMeasurement(organization_name='WHO', pollutant='PM10', limit=50.0, percent=79.34)])


# def test_create_index_dict():
#     pass


# def test_convert_data_for_chart():
#     pass
